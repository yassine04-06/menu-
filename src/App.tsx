...
const MENU_DATA = [
  {
    ...
    dishes: [
      ...
      { name: 'Colazione Light', desc: 'Caffetteria, panetteria msemen o batbout, contorni.', price: '8.50 €', img: '/images/dish_0_11.jpeg' },
      { name: 'Colazione con Omelette', desc: 'Caffetteria, spremuta o frullato, batbout, omelette o frittata.', price: '3.00 €', img: '/images/dish_0_12.jpeg' },
    ],
  },
  {
    id: 'tacos',
    ...
    dishes: [
      ...
      { name: 'Tacos Manzo BBQ', desc: 'Macinato di manzo, patatine, cipolla caramellata e salsa BBQ.', price: '8.50 €', img: '/images/dish_1_21.jpeg' },
      { name: 'Tacos Manzo e Cheddar', desc: 'Macinato di manzo, patatine, peperoni a cubetti e cheddar.', price: '8.50 €', img: '/images/dish_0_0.jpeg' },
      { name: 'Tacos Merguez Classic', desc: 'Salsiccia merguez, patatine, cheddar, salsa algerienne e ketchup.', price: '8.50 €', img: '/images/dish_1_23.jpeg' },
      { name: 'Tacos Merguez Fresh', desc: 'Salsiccia, patatine, pomodoro e cipolla, lattuga, salsa algerienne.', price: '8.50 €', img: '/images/dish_0_5.jpeg' },
      { name: 'Menu Tacos Combo', desc: 'Tacos msemen + patatine + bibita in vetro.', price: '12.00 – 15.00 €', img: '/images/dish_0_12.jpeg' },
    ],
  },
  {
    id: 'antipasti',
    ...
    dishes: [
      ...
      { name: 'Bestila di Pollo', desc: 'Pasta fillo croccante ripiena di pollo speziato, mandorle tostate, cannella e zafferano.', price: '7.50 €', img: '/images/dish_2_45.jpeg' },
      { name: 'Bestila di Pesce', desc: 'Pesce bianco, gamberi, calamari, funghi e spaghettini di riso in pasta fillo croccante.', price: '8.00 €', img: '/images/dish_2_49.jpeg' },
  ...
  },
  {
    ...
    dishes: [
      ...
      { name: 'Padella Salsiccia', desc: 'Salsiccia, uova strapazzate, salsa pomodoro e formaggio. Servita con pane.', price: '9.00 €', img: '/images/dish_3_69.jpeg' },
      { name: 'Padella Gamberi', desc: 'Gamberi, uova strapazzate, salsa pomodoro, formaggio, coriandolo. Servita con pane.', price: '11.00 €', img: '/images/dish_3_71.jpeg' },
    ],
  },
  {
    id: 'tajine',
